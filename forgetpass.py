...
#             entered_username = forgot_username_entry.get()
#             new_password = new_password_entry.get()
#             confirm_password = confirm_password_entry.get()

#             if not entered_username or not new_password or not confirm_password:
...
#             c.execute("SELECT username FROM hostel WHERE username=?", (entered_username,))
#             result = c.fetchone()

#             if result:
#                 c.execute("UPDATE hostel SET password=? WHERE username=?", (new_password, entered_username))
#                 conn.commit()
...
#         forgot_password_window = customtkinter.CTkToplevel()
#         forgot_password_window.title("Forgot Password")
#         forgot_password_window.geometry("400x400")

#         forgot_frame = customtkinter.CTkFrame(master=forgot_password_window, width=400, height=400, fg_color="white")
#         forgot_frame.place(relx=0, rely=0)

#         forgot_label = customtkinter.CTkLabel(master=forgot_frame, text="Forgot Password", font=("bold", 25), text_color="#614BD4")
#         forgot_label.place(relx=0.1, rely=0.1)

#         forgot_username_label = customtkinter.CTkLabel(master=forgot_frame, text="Username:", bg="white", fg="black", font=("20"))
#         forgot_username_label.place(relx=0.1, rely=0.3)

#         forgot_username_entry = customtkinter.CTkEntry(master=forgot_frame, width=200, fg_color="gray", text_color="white", corner_radius=10, bg_color="white")
#         forgot_username_entry.place(relx=0.4, rely=0.3)

#         new_password_label = customtkinter.CTkLabel(master=forgot_frame, text="New Password:", bg="white", fg="black", font=("20"))
#         new_password_label.place(relx=0.1, rely=0.4)

#         new_password_entry = customtkinter.CTkEntry(master=forgot_frame, width=200, fg_color="gray", text_color="white", corner_radius=10, bg_color="white", show="*")
#         new_password_entry.place(relx=0.4, rely=0.4)

#         confirm_password_label = customtkinter.CTkLabel(master=forgot_frame, text="Confirm Password:", bg="white", fg="black", font=("20"))
#         confirm_password_label.place(relx=0.1, rely=0.5)

#         confirm_password_entry = customtkinter.CTkEntry(master=forgot_frame, width=200, fg_color="gray", text_color="white", corner_radius=10, bg_color="white", show="*")
#         confirm_password_entry.place(relx=0.4, rely=0.5)
...
#                                                justify=LEFT, text_color="white", font=("bold", 20))
